...
foreach ( $items as $key => $item ) :
	...
	<div class="responsive-pros-cons__item responsive-pros-cons__item-<?php echo esc_attr( $key ); ?>">
		<div class="flex aic responsive-pros-cons__header">
			<div class="flex aic jcc responsive-pros-cons__icon responsive-pros-cons__icon--<?php echo esc_attr( $key ); ?>">
				<?php if ( $key === 'pros' ) : ?>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="44" height="44" fill="#4CAF50">
				...
				<?php else : ?>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="44" height="44" fill="#EF0856">
